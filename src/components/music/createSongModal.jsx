...
import { createSongRequest } from '../../api/song';
import './EditSongModal.css'; // Reutilizamos el mismo CSS
...
const CreateSongModal = ({ onClose, onSuccess }) => {
    ...
    const validateForm = () => {
        ...
        if (!image) {
            newErrors.image = 'La imagen de portada es requerida';
        }
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Agregar imagen (requerida en creación)
    ...
    return (
        <div className="esm-modal-overlay" onClick={onClose}>
            <div className="esm-modal esm-modal-large" onClick={(e) => e.stopPropagation()}>
                    ...
                    <div className="esm-form-section">
                        ...
                        <div className="esm-image-upload">
                            {imagePreview ? (
                                ...
                                <div className="esm-image-preview esm-image-preview-empty">
                                    <div className="esm-image-placeholder">
                                        <span className="esm-placeholder-icon">🖼️</span>
                                        <span className="esm-placeholder-text">
                                            {errors.image ? 'Imagen requerida' : 'Selecciona una imagen'}
                                        </span>
                                    </div>
                                </div>
                            )}
                            ...
                            <div className="esm-file-upload-container">
                                <label className="esm-file-upload-label">
                                    ...
                                    <span className="esm-file-upload-text">
                                ...
                                {errors.image && (
                                    <span className="esm-form-error" style={{ marginTop: '10px' }}>
                                        ⚠️ {errors.image}
                                    </span>
                                )}
                                <small className="esm-file-hint">
                                    Formatos: JPG, PNG, WebP • Máx: 5MB • Requerido
                                </small>
                            </div>
                        </div>
                    </div>
